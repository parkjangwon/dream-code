...
export const slashCommands = [
  ...
  { name: "/clear", summary: "Clear active session transcript", acceptsArgs: false },
  { name: "/compact", summary: "Compact current session context", acceptsArgs: false },
  { name: "/context", summary: "Show loaded context and storage notes", acceptsArgs: false },
  ...
  { name: "/permission", summary: "Set permission mode or preset", acceptsArgs: true },
  ...
  { name: "/restore", summary: "Restore latest file checkpoint", acceptsArgs: true },
  ...
  { name: "/runs", summary: "Inspect or revert agent runs", acceptsArgs: true },
  ...
  { name: "/swarm", summary: "Explode a goal across parallel lanes", acceptsArgs: true },
  { name: "/tasks", summary: "Show or add tasks", acceptsArgs: true },
  { name: "/verify", summary: "Plan verification checks", acceptsArgs: true },
  { name: "/workday", summary: "Show edit-test-review readiness", acceptsArgs: true },
